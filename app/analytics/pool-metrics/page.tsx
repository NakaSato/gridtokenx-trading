...
export default function PoolMetrics() {
  return (
    <div className="flex h-full w-full flex-col">
      <section className="flex w-full flex-col space-y-5 px-2 py-9">
        <h1 className="w-full px-4 text-2xl">Analytics</h1>
        <div className="w-full px-4">
          <PoolMetricStats />
        </div>
      </section>
      <section className="w-full border-b border-t py-4">
        <PoolMetricFilters />
      </section>
