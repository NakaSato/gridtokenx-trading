            ...
            if (
              ...
              for (let t = 0; t < v; t++) {
                const r = Math.round(P + t * l + 0.5),
                  s = e(p[t]).map(
                    (e, t) => new n.Point(r + (2 * t - 1), Math.round(x(e)) + S)
                  ),
        ...
        _updateImpl(e) {
          ...
          if (i.showWave.value()) {
            ...
            ;(this._polylineRenderer.setData(e),
              c.append(this._polylineRenderer))
          }
        ...
        hitTest(e) {
          ...
          const [t, i] = (function (e, t) {
            ...
            if (!s && void 0 !== r) {
              ...
              a =
                r.circleRadius > 0 &&
                (0, w.pointInCircle)(t, new o.Point(n.x, s), r.circleRadius + i)
            }
            return [s, a]
          })(this._data, e)
          if (t || i) {
    ...
    90139: (e, t, i) => {
      ...
      class E {
        constructor(e) {
          ...
          const t = k,
            i = D + t
          ;((this._maxRowHeight = 3 * i - t + 2 * N + 2),
