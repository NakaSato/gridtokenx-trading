...
export class AuctionSimulator {
    ...
    calculate_clearing_price() {
        try {
            ...
            wasm.auctionsimulator_calculate_clearing_price(retptr, this.__wbg_ptr);
...
export class Clusterer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ClustererFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_clusterer_free(ptr, 0);
    }
    /**
    ...
    get_clusters(min_lng, min_lat, max_lng, max_lat, zoom) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.clusterer_get_clusters(retptr, this.__wbg_ptr, min_lng, min_lat, max_lng, max_lat, zoom);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    load_points(points) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.clusterer_load_points(retptr, this.__wbg_ptr, addHeapObject(points));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    constructor() {
        const ret = wasm.auctionsimulator_new();
        this.__wbg_ptr = ret >>> 0;
        ClustererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) Clusterer.prototype[Symbol.dispose] = Clusterer.prototype.free;
...
export class OrderBook {
    ...
    get_depth(levels) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.orderbook_get_depth(retptr, this.__wbg_ptr, levels);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    load_orders(orders) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.orderbook_load_orders(retptr, this.__wbg_ptr, addHeapObject(orders));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    match_orders() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.orderbook_match_orders(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
export class Simulation {
    ...
    get_flows() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.simulation_get_flows(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    get_nodes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.simulation_get_nodes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    set_flows(flows) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.simulation_set_flows(retptr, this.__wbg_ptr, addHeapObject(flows));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    set_nodes(nodes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.simulation_set_nodes(retptr, this.__wbg_ptr, addHeapObject(nodes));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
...
export class Topology {
    ...
    find_critical_nodes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.topology_find_critical_nodes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    find_path(start_id, end_id) {
        try {
            ...
            wasm.topology_find_path(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    set_graph(nodes, edges) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.topology_set_graph(retptr, this.__wbg_ptr, addHeapObject(nodes), addHeapObject(edges));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
...
export function calculate_bezier(x1, y1, x2, y2, curve_intensity, segments) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.calculate_bezier(retptr, x1, y1, x2, y2, curve_intensity, segments);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v1 = getArrayF64FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export4(r0, r1 * 8, 8);
 ...
 * @returns {any}
 */
export function calculate_black_scholes(s, k, t, r, v) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.calculate_black_scholes(retptr, s, k, t, r, v);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function create_commitment(value, blinding) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(blinding, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.create_commitment(retptr, value, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function create_range_proof(amount, blinding) {
    try {
        ...
        const ptr0 = passArray8ToWasm0(blinding, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.create_range_proof(retptr, amount, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function create_transfer_proof(amount, sender_balance, sender_blinding, amount_blinding) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(sender_blinding, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(amount_blinding, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        wasm.create_transfer_proof(retptr, amount, sender_balance, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function crypto_msg_hash(data) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.crypto_msg_hash(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
const ClustererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_clusterer_free(ptr >>> 0, 1));
