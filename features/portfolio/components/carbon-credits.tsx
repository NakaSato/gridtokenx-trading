...
export function CarbonCredits() {
  ...
  const availableCredits = Number.isFinite(parsedAvailable)
    ? parsedAvailable
    : 0
        ...
        <Card className="rounded-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-500">
              {balance?.available_credits || '0.00'}
            </div>
            <p className="text-xs text-muted-foreground">
              Available for trade/offset
            </p>
          </CardContent>
        </Card>
        <Card className="rounded-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {balance?.retired_credits || '0.00'}
            </div>
            <p className="text-xs text-muted-foreground">
              Environmentally offset
            </p>
          </CardContent>
        </Card>
            ...
            <CardContent>
              <form className="space-y-4">
                ...
                <p className="text-center text-[10px] italic text-muted-foreground">
                  * 1.00 Credit ≈ {(KG_CO2_PER_CREDIT / 1000).toFixed(4)} tons
                  CO2 offset
                </p>
              </form>
            </CardContent>
          ...
          <Card className="rounded-sm border-primary/10">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  You are in the top 15% of renewable energy producers this
                  month!
                </p>
              </div>
            </CardContent>
