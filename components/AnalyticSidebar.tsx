      ...
      <ul>
        {[
          ...
          <li
            className={cn(
              active === item.name
                ? 'border-r-2 border-primary bg-primary-foreground text-primary'
                : 'border border-transparent text-secondary-foreground',
              'cursor-pointer rounded-l-sm p-4 text-sm'
            )}
            key={idx}
