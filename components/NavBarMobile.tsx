        ...
        <div className="w-full pb-10 px-3">
          {connected ? (
            ...
            <Button
              ...
              className="w-full h-fit border border-transparent py-[7px] px-4 rounded-sm gap-2 text-background"
            >
              <svg
