  ...
  return (
    <div className="flex -space-x-1.5">
      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-inherit ring-2 ring-border">
        <Image
          src={strategy.asset.logo}
          alt={strategy.asset.name}
          width={24}
          height={24}
      ...
      <div
        className={`h-6 w-6 rounded-full bg-inherit ${strategy.symbol === 'USDC' ? 'hidden' : 'flex'} items-center justify-center ring-2 ring-border`}
      >
