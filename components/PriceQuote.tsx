...
export default function PriceQuote({
  ...
  return (
    ...
    >
      ...
      >
        <span className="flex h-6 items-center text-sm font-medium text-secondary-foreground">
          Order Summary
        </span>
        <div className="flex items-center space-x-3">
          <Button className="h-auto w-fit rounded-sm bg-secondary p-2">
      ...
      {dropDownActive && (
        <div className="space-y-4 border-t-[1px] px-6 py-5">
          <div className="flex w-full flex-col space-y-3">
            <div className="flex w-full items-center justify-center space-x-2 whitespace-nowrap rounded-sm bg-accent px-3 py-2 text-base font-normal">
            ...
            <div className="flex w-full flex-col space-y-1">
              ...
              <div className="flex w-full justify-between">
                ...
                <span className="text-sm font-medium text-secondary-foreground">{`<0.01%`}</span>
              </div>
            </div>
          </div>
          {moreInfo && (
          ...
          <div className="flex w-full justify-start">
            <Button
              className="space-x-2 bg-inherit p-0 text-primary shadow-none"
